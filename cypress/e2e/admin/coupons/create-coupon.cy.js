...
describe('(Admin) Tạo mới mã giảm giá', () => {
  ...
  context('Check validation', () => {
    ...
    it('CCP38: [Ngày hết hạn] - Kiểm tra khi chọn ngày hết hạn = hiện tại', () => {
    ...
    it('CCP39: [Ngày hết hạn] - Kiểm tra khi chọn ngày hết hạn > hiện tại', () => {
      const currentDate = new Date()
  ...
  context('Check logic', () => {
    it('CCP41: Xác minh có thể tạo mới coupon thành công', () => {
      cy.fixture('/coupons/create-coupon').then((data) => {
    ...
    it('CCP42: Kiểm tra khi tạo mới một coupon đã tồn tại', () => {
      cy.fixture('/coupons/create-coupon').then((data) => {
        const validCoupon = data.validCoupon
    ...
    it('CCP43: Xác minh có thể huỷ việc tạo mới coupon', () => {
