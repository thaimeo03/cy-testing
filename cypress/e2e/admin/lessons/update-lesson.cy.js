describe('(Admin) update lesson',()=>{
    const LESSON_ID = '7f4cc4cc-e039-482a-8f9f-50cd35fabda2'
    beforeEach(()=>{
        cy.loginAdmin()
    ...
    //     })
        ...
        //     cy.get('button').contains('Cập nhật').click()
        //     cy.get('bidv-error[formcontrolname="title"]').should('contain.text','title must be shorter than or equal to 300 characters')
        // })
